...
{
    class Linkor : Warship, IEquatable<Linkor>
    {
        /// <summary>
        /// Дополнительный цвет
        /// </summary>
        ...
        /// <returns></returns>
        public bool Equals(Linkor other)
        {
            if (other == null)
            {
                return false;
            ...
            if (FrontWeapon != other.FrontWeapon)
            {
                return false;
            }
            if (SideWeapon != other.SideWeapon)
            {
                return false;
            }
            return true;
